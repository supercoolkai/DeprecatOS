...
#### **BIT_32_PER_BLK** *(src/fs/block/blockController.h, user/shell/shell.c)*

#### **BLACK** *(src/drivers/fb/fbController.h, user/shell/shell.c)*
...
#### **READ_48_AMT** *(src/drivers/disk/ata.h)*

#### **RED** *(src/drivers/fb/fbController.h, user/shell/shell.c)*

#### **RINGBUFFER_H** *(src/util/rb/ringBuffer.h)*

#### **SCHEDULER_H** *(src/process/scheduler/scheduler.h)*

#### **SENTINEL** *(src/userland/syscall/syscallController.h, user/shell/sys/syscall.h)*
...
#### **TSSCONTROLLER_H** *(src/process/cpu/tssController.h)*
...
#### **WHITE** *(src/drivers/fb/fbController.h, user/shell/shell.c)*

#### **WORDS_PER_BLK** *(src/fs/block/blockController.h)*

#### **YELLOW** *(src/drivers/fb/fbController.h, user/shell/shell.c)*
